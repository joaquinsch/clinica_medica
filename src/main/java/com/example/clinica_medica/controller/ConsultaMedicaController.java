...
public class ConsultaMedicaController {
	 ...
	 * ESTÉ ASOCIADO A OTRA CONSULTA MEDICA. VERIFICAR MONTOTOTAL DE LA CONSULTA CUANDO SE LE EDITA PAQUETE O SERVICIO 
	 ...
	 *  - VALIDAR EXCEPCION EMAIL INVALIDO PACIENTE
	 * -----------------------------------------------------------
